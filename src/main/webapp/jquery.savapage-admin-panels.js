...
( function($, window, document, JSON, _ns) {"use strict";
        ...
        _ns.PanelAccountVoucherBase = {
            ...
            m2v : function(my) {
                var id, val, _view = _ns.PanelCommon.view;
        ...
        _ns.PanelAppLogBase = {
            ...
            m2v : function(my) {
                var id, _view = _ns.PanelCommon.view;
        ...
        _ns.PanelConfigPropBase = {
            ...
            v2m : function(my) {
                var sel = $('#sp-config-containing-text'), present = (sel.val().length > 0)
                //
                , _view = _ns.PanelCommon.view
                //
                ;
        ...
        _ns.PanelDashboard = {
            ...
            refreshSysStatus : function() {
                ...
                var scrollTop, heightXyChart, heightPieChart, html
                //
                , _view = _ns.PanelCommon.view
                //
        ...
        _ns.PanelDevicesBase = {
            ...
            v2m : function(my) {
                var val, sel = $('#sp-device-containing-text')
                //
                , present = (sel.val().length > 0)
                //
                , _view = _ns.PanelCommon.view
        ...
        _ns.PanelOptions = {
            ...
            onOutput : function(my, output) {
                ...
                my.onSmartSchoolEnabled(_view.isCbChecked($('#smartschool\\.1\\.enable')),
        ...
        _ns.PanelQueuesBase = {
            ...
            m2v : function(my) {
                var id, val = my.input.select.text
                //
                , _view = _ns.PanelCommon.view
                //
                ;
            ...
            v2m : function(my) {
                ...
                , _view = _ns.PanelCommon.view
                //
                , sel = $('#sp-queue-containing-text'), present = (sel.val().length > 0)
                //
                ;
