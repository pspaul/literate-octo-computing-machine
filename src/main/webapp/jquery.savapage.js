...
( function($, window, document, _ns) {"use strict";
        ...
        _ns.Api = function(_i18n, _user) {
             ...
             */
            this.getUrl4Pdf = function(ranges, removeGraphics) {
                // number of milliseconds since 1970/01/01
                var d = new Date();
                return '/api?request=pdf&user=' + _user.id + '&ranges=' + ranges + '&graphics=' + ( removeGraphics ? '0' : '1') + '&unique=' + d.getTime().toString();
            };
