...
( function($, window, document, JSON, _ns) {"use strict";
        ...
        _ns.PageDevice = function(_i18n, _view, _model) {
            ...
            _onProxyPrintEnabled = function(cb) {
                ...
                _view.visible($('#sp-device-proxy-print-auth-fields'), 
                    _view.isCbChecked(cb) && _model.editDevice.deviceType === 'CARD_READER');
            };
            ...
            _m2vAuthDefault = function() {
                _view.checkRadioValue(_AUTH_MODE_DEFAULT, 
                    _model.editDevice.attr[_AUTH_MODE_DEFAULT]);
            };
        ...
        _ns.PageAdmin = function(_i18n, _view, _model) {
            ...
            $(_self.id()).on('pagebeforeshow', function(event, ui) {
                ...
                $(this).on('click', '#stop-imap', null, function() {
                    _self.onFlatRequest('imap-stop');
                    return false;
                });
                $(this).on('click', '#start-imap', null, function() {
                    _self.onFlatRequest('imap-start');
                    return false;
                });
                ...
                $(this).on('click', '#stop-smartschool', null, function() {
                    _self.onFlatRequest('smartschool-stop');
                    return false;
                });
                $(this).on('click', '#start-smartschool', null, function() {
                    _self.onFlatRequest('smartschool-start');
                    return false;
                });
                ...
                $(this).on('change', "input:checkbox[id='smartschool.1.enable']", null, function(e) {
                    _panel.Options.onSmartSchoolEnabled(_view.isCbChecked($(this)), 
                        _view.isCbChecked($('#smartschool\\.2\\.enable')));
                });

                $(this).on('change', "input:checkbox[id='smartschool.2.enable']", null, function(e) {
                    _panel.Options.onSmartSchoolEnabled( 
                        _view.isCbChecked($('#smartschool\\.1\\.enable')), _view.isCbChecked($(this)));
                });
                ...
                $(this).on('click', '#apply-smartschool', null, function() {
                    _self.onApplySmartSchool(
                        _view.isCbChecked($('#smartschool\\.1\\.enable')),
                        _view.isCbChecked($('#smartschool\\.2\\.enable'))
                        );
                    return false;
                });
                ...
                $(this).on('click', '#apply-smartschool-papercut', null, function() {
                    _self.onApplySmartSchoolPaperCut(
                        _view.isCbChecked($('#smartschool\\.papercut\\.enable'))
                        );
                    return false;
                });
